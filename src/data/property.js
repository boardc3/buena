export const PROPERTY = {
  title: '5441 E Via Buena Vista',
  subtitle: 'Paradise Valley, AZ 85253 · Mockingbird Lane Estates',
  address: '5441 E Via Buena Vista, Paradise Valley, AZ 85253',
  price: '$12,495,000',
  quickFacts: [
    { label: 'Living', value: '8,492 sq ft' },
  ...
  pillars: [
    {
      title: 'Wellness guest house — two lifestyles, one estate',
      body:
        'A dedicated wellness structure means training, recovery, and spa rituals can happen while the main home stays ready for hosting—without crossing paths.',
    },
    {
    ...
    },
    {
      ...
      body:
        'A 1.05-acre program designed for living outside: resort pool/spa, misting, meditation lawn, expansive patios, and separation from neighbors.',
    },
    {
      title: 'Mummy Mountain views as a daily backdrop',
      body:
  ...
  copy: {
    heroHeadline: 'Privacy. Wellness. Views.',
    heroSubhead:
